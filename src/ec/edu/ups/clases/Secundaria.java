...
public class Secundaria extends JFrame implements ActionListener {
 ...
 public void actionPerformed(ActionEvent e) {
        if (e.getSource()==boton1) {
             fig=new Graficas(200, 200, 100, 100);
        ...
        if (e.getSource()==boton3) {
            fig=new Graficas(200, 200, 250, 100);
             //setFig(fig);
             boolean panel=panelP.creo3(fig);
             repaint ();
        }
        if (e.getSource()==boton4) {
            fig=new Graficas(200, 75, 350, 100);
             //setFig(fig);           
    ...
    public Graficas getFig() {
        return fig;
    }

    public void setFig(Graficas fig) {
        this.fig = fig;
    }
    ...
    public void initComponentes(){
        ...
        fig = new Graficas(100, 100, 100, 100);
    }
