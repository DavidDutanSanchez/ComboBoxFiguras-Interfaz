...
public class Panel extends JPanel implements KeyListener {
    ...
    public boolean creo1(Graficas GraficasF){
        if (GraficasF!=null){
            secundaria=GraficasF;
            a=secundaria.getX();
            b=secundaria.getY();
            c=secundaria.getAlto();
            d=secundaria.getAncho();
            System.out.println("--");
            af=true;
            return true;
        }else{
      ...
      public boolean creo2(Graficas GraficasF){
        if (GraficasF!=null){
            secundaria=GraficasF;
            a=secundaria.getX();
            b=secundaria.getY();
        ...
        public boolean creo3(Graficas GraficasF){
        if (GraficasF!=null){
            secundaria=GraficasF;
            a=secundaria.getX();
            b=secundaria.getY();
          ...
          public boolean creo4(Graficas GraficasF){
        if (GraficasF!=null){
            secundaria=GraficasF;
            a=secundaria.getX();
            b=secundaria.getY();
